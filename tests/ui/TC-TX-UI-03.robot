*** Settings ***
Documentation     UI test suite for funds transfer blank amount validation
...
*** Test Cases ***
TC-TX-UI-03
    [Documentation]    Verify blank amount funds transfer rejection
    [Tags]    ui    regression
    ...
    Log To Console    Transferring funds with blank amount
